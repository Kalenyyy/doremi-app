export default function PosisiAtas() {
    return (
        <svg
            viewBox="0 0 260 200"
            width="260"
        ...
        >
            ...
            {/* HP tegak, kepala ke atas */}
            <rect x="104" y="36" width="52" height="88" rx="9" fill="#1a1a1a" />
            <rect x="108" y="41" width="44" height="72" rx="6" fill="#2e2e2e" />
            {/* Kamera */}
            ...
            {/* Home bar */}
            <rect x="122" y="108" width="16" height="3" rx="1.5" fill="#555" />
            ...
            <line
                ...
                strokeDasharray="5,4"
            />
            <polygon points="200,18 193,36 207,36" fill="#1a1a1a" />
